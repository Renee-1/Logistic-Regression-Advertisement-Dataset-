...
In this project I have worked with an advertising data set, indicating whether or not a particular internet user clicked on an Advertisement on a company website. I have created a model that will predict whether or not they will click on an ad based off the features of that user.
...
**Splited the data into training set and testing set using train_test_split**
"""
